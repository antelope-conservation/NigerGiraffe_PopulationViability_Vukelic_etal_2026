...
INTRODUCING PRECIPITATION DATA AND FILTERING JJA PRECIPITATION
```{r}
library(ggplot2)
library(dplyr)
library(lubridate)
...
#Daily precipitation in Giraffe zone from 2005 to 2018
...
EXPORTING TO MARK FOR THE GOF TESTING
```{r}
